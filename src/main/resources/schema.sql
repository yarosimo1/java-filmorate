...
CREATE INDEX IF NOT EXISTS REVIEW_REACTIONS_REVIEW_FK_INDEX ON PUBLIC.REVIEW_REACTIONS (REVIEW_ID);
CREATE INDEX IF NOT EXISTS REVIEW_REACTIONS_USER_FK_INDEX ON PUBLIC.REVIEW_REACTIONS (USER_ID);
