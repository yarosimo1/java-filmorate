...
import ru.yandex.practicum.filmorate.storage.friendshipStatus.FriendshipStatusStorage;
import ru.yandex.practicum.filmorate.storage.friendshipStatus.InMemoryFriendshipStatusStorage;
...
public class FriendshipStatusService {
    ...
    public Collection<FriendshipStatus> getFrinedshipStatus() {
        log.info("Получен запрос на получение всех статусов дружбы {}",
                inMemoryFriendshipStatusStorage.getFriendshipStatus().size());
    ...
    public FriendshipStatus postFriendshipStatus(FriendshipStatus friendshipStatus) {
        ...
        log.info("Добавлен новый статус дружбы: id={}, name={}, isAccepted={}",
                friendshipStatus.getId(),
                friendshipStatus.getName(),
                friendshipStatus.getIsAccepted());
    ...
    public FriendshipStatus putFriendshipStatus(FriendshipStatus newFriendshipStatus) {
        ...
        FriendshipStatus oldFriendshipStatus =
                inMemoryFriendshipStatusStorage.getFriendshipStatus().get(newFriendshipStatus.getId());
